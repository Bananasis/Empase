    ...
    SubShader
    {
        ...
        Pass
        {
			...
			faceColor += input.underlayColor * (1 - saturate(d - input.texcoord2.w)) * saturate(1 - sd) * (1 - faceColor.a);
                ...
                #if GLOW_ON
				float VoroNoise = -Unity_Voronoi_float(input.position.xy,_Time.y*_AngleOffset,_Density);
                float4 glowColor = GetGlowColor(sd+VoroNoise*_NoiseStr, scale);
